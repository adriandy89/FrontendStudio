...
@Component({
  selector: 'app-contrato-modificar',
  templateUrl: './contrato-modificar.component.html',
  styleUrls: ['./contrato-modificar.component.css']
})
export class ContratoModificarComponent implements OnInit {
  ...
  getContrato() {
    ...
    this.contratosService.getContrato().subscribe(
      data => {
        ...
        this.telefonos = this.contrato.telefono;
        this.radio = "manual";
        this.precioFinal = this.contrato.precio;
        this.hora_cita = this.contrato.hora_cita;
        this.fechaCita = this.contrato.fecha_cita;
        this.fechaEntrega = this.contrato.fecha_entrega;
        if (this.selectContrato == "---") {
          ...
          this.tipoFotos.forEach(tipoFoto => {
            this.fotos.forEach(foto => {
              if (foto.dimension == tipoFoto.dimension) {
